...
.. index:: 
   single: Parameters; 1D Penumbra 9050 Left

1D Penumbra 9050 Left
=====================

The left 90%-50% penumbra is defined as the distance from the first point on the profile at 90% of the CAX value to the first point that reaches 50% of the CAX value on the left side of the profile:
...
**Protocol invocation name**: 1D Penumbra 9050 Left
