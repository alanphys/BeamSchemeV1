...
AssertEquals('Detector Cols',53,fBeam.Cols);
...
AssertEquals('Detector XRes',0.5,fBeam.XRes);
AssertEquals('Detector YRes',0.5,fBeam.YRes);
AssertEquals('Detector Cols',45,fBeam.Cols);
...
AssertEquals('Detector Cols',32,fBeam.Cols);
...
AssertEquals('Detector Cols',27,fBeam.Cols);
...
AssertEquals('Detector Cols',1190,fBeam.Cols);
...
AssertEquals('Detector Cols',306,fBeam.Cols);
...
AssertEquals('Detector XRes',0.1,fBeam.XRes);
AssertEquals('Detector YRes',0.1,fBeam.YRes);
AssertEquals('Detector Cols',178,fBeam.Cols);
...
AssertEquals('Detector Cols',512,fBeam.Cols);
...
AssertEquals('Detector XRes',0.0339,fBeam.XRes);
AssertEquals('Detector YRes',0.0339,fBeam.YRes);
AssertEquals('Detector Cols',50,fBeam.Cols);
AssertEquals('Detector Rows',50,fBeam.Rows);
AssertEquals('Detector Centre',416.50,fBeam.Centre);
AssertEquals('Detector Max',463.0,fBeam.Max);
AssertEquals('Detector Min',13,fBeam.Min);
end;
