.. index:: 
   single: Parameters; 1D Field Edge Left 50

1D Field Edge Left 50
=====================

Linear distance from the central axis as defined by the array or imaging modality to the point on the left side of the displayed profile where the dose profile drops below 50% of the central axis dose. If this point lies between two measured values the distance is linearly interpolated. This is the traditional field edge for flattened beams.
...
**Protocol invocation name**: 1D Field Edge Left 50
